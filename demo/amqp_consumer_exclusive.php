...
*/
list($queue_name, ,)=$ch->queueDeclare($queue, false, false, true, true);
...
$ch->queueBind($queue_name, $exchange);
...
$ch->basicConsume($queue_name, $consumer_tag, false, false, true, false, 'process_message');
